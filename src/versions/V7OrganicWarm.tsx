...
import s from './V7OrganicWarm.module.css'

export default function V7OrganicWarm() {
  useLenis()
  ...
  return (
    <div className={s.root}>
      ...
      <div className={s.blob} aria-hidden />
      ...
      <main className={s.main}>
        <section id="home" className={s.hero}>
          ...
          <h1 className={s.heroTitle}>
            ...
            <Reveal as="span" className={s.lItalic} delay={0.12}>Zhang</Reveal>
          </h1>
          ...
          <Reveal className={s.heroActions} delay={0.3}>
            ...
            <a className={s.btnSoft} href={profile.links.handshake} target="_blank" rel="noreferrer">Handshake</a>
            <a className={s.btnSoft} href={profile.resumePreview} target="_blank" rel="noreferrer"><DocIcon size={14} /> Preview resume</a>
            <a className={s.btnSoft} href={profile.resumeDownload} download><DownloadIcon size={14} /> Download</a>
          </Reveal>
        </section>
        ...
        <section id="anomaly" className={s.work}>
          ...
          <div className={s.workBody}>
            <Reveal className={s.media}>
              <YouTube id={anomaly.media!.src} title={anomaly.title} accent="#c66b3d" />
        ...
        <footer id="contact" className={s.footer}>
          <Reveal as="h2" className={s.footerTitle}>Let&apos;s grow something together.</Reveal>
