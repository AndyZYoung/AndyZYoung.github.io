...
import s from './V9Bauhaus.module.css'
...
export default function V9Bauhaus() {
  useLenis()
      ...
      <main className={s.main}>
        <section id="home" className={s.hero}>
          <div className={s.heroShapes} aria-hidden>
            <motion.span className={s.shapeBlue} {...slideIn(-80)} />
            <motion.span className={s.shapeMustard} {...slideIn(80)} />
            <motion.span className={s.shapeBrick} {...slideIn(60)} />
          </div>
          <Reveal className={s.heroKicker}>{profile.disciplines.join('  /  ')}</Reveal>
          <h1 className={s.heroTitle}>
            <Reveal as="span" className={s.l} delay={0.05}>YANG</Reveal>
            <Reveal as="span" className={s.lAccent} delay={0.12}>ZHANG</Reveal>
          </h1>
        ...
        <section id="anomaly" className={s.work}>
          ...
          <div className={s.workBody}>
            <motion.div className={s.media} {...slideIn(-100)}>
              <YouTube id={anomaly.media!.src} title={anomaly.title} accent="#e6a911" />
            ...
            <motion.div className={s.workText} {...slideIn(100)}>
              ...
              <div className={s.stack}>{anomaly.stack.map((t) => <span key={t}>{t}</span>)}</div>
            </motion.div>
          </div>
        </section>
