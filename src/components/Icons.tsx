...
export function HandshakeIcon({ size = 20, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round" className={className} aria-hidden>
      <path d="M11 17 8.5 14.5a1.4 1.4 0 0 1 2-2l1.5 1.5" />
      <path d="m3 9 4-4 5 4 2-1.5a2 2 0 0 1 2.4.2L21 11" />
      <path d="m21 11-4 4-2.5-2.5" />
      <path d="m12 13 2.2 2.2a1.4 1.4 0 0 0 2-2L13.5 10" />
      <path d="m3 9 3 7" />
    </svg>
  )
}
